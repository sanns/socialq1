...
import DeleteChapterlBtn from '../Worlds/DeleteChapterBtn';
  ...
  render() {
    return (
      <div className='chapter-levels-container'>
        ...
        {/*<DeleteChapterlBtn chapter={this.props.task}/>*/}
        <DeleteTaskBtn task={this.props.task}/>
        
        <div style={{ fontSize: '22px', marginBottom: '10px' }}>
          Задача {this.props.index + 1} - id: {this.props.task.id}
